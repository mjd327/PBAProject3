...
public class RigidBody
{
	...
	RigidBody(RigidBody body) {	this(body.B); }
	...
	/** Returns true if at least one block is a shade of pure blue, i.e. c = (a,a,b) with b>a */
	boolean hasABlueBlock()
	{
		for(Block b : B)
		{
			boolean isBlue = ((b.c.x == b.c.y) && (b.c.z > b.c.x));
	...
	public int getNBoundaryBlocks()
	{
		if(numBoundaryBlocks == 0)
		{
			for(Block b : B)
			{
				double H      = 2.*b.h();
				...
				//System.out.print(" "+nNeigh+" ");
				if(nNeigh < 8) numBoundaryBlocks += 1;
			}
		}
		return numBoundaryBlocks;
	}
	...
	public Point2d getMinBound() {return minBound;}
	public Point2d getMaxBound() {return maxBound;}
